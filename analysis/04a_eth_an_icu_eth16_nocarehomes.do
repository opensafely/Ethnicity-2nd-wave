...
cap log close
macro drop hr
log using ./logs/04a_eth_an_icu_eth16.log, replace t 

cap file close tablecontent
file open tablecontent using ./output/table2_icu_eth16.txt, write text replace
...
/* Estout================================================================*/ 
esttab model1 model2 model3 model4 model5 using ./output/estout_icu_eth16.txt, b(a2) ci(2) label wide compress eform ///
	title ("`i'") ///
	varlabels(`e(labels)') ///
	stats(N_sub) ///
	append 
