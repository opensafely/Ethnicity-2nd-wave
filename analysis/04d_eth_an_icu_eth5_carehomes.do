...
file write tablecontent ("Table 2: Association between ethnicity in 5 categories and COVID-19 outcomes - care homes") _n
...
/* Estout================================================================*/ 
esttab model1 model2 model3 model4 model5 using ./output/estout_icu_eth5_carehomes.txt, b(a2) ci(2) label wide compress eform ///
	title ("`i'") ///
	varlabels(`e(labels)') ///
	stats(N_sub) ///
	append 
...
outsheet using ./output/FP_icu_eth5_carehomes.txt, replace
